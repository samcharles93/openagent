...
export function normalizeOpenAgentRelativePath(rawPath) {
...
export function getOpenAgentWorkspacePaths(args) {
    ...
    const notesRoot = path.join(workspacePath, "files", ...config.workspace.notesDirectory.split("/"));
    return {
        workspacePath,
        notesRoot,
