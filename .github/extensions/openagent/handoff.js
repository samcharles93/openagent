...
import { inferOpenAgentPhase, readOpenAgentRouteState, } from "./routing.js";
...
export function buildOpenAgentResumeHandoff(artifact, extraContext) {
    return [
...
export async function writeOpenAgentHandoffArtifact(args) {
    ...
    const artifact = {
        ...
        goal: args.goal.trim(),
        workDone: args.workDone && args.workDone.length > 0
            ? args.workDone
            : [
        ...
        refs: args.refs && args.refs.length > 0
            ? args.refs
            : [
