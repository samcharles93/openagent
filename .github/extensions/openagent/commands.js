...
import { bootstrapOpenAgentTask, formatOpenAgentBootstrapResult, } from "./bootstrap.js";
import { loadCustomCommands, renderCustomCommandPrompt, } from "./command-loader.js";
import { OPENAGENT_AGENT_NAMES, formatConfigSummary, isOpenAgentAgentName, loadOpenAgentConfig, } from "./config.js";
import { runOpenAgentDoctor } from "./doctor.js";
import { buildOpenAgentResumeHandoff, readOpenAgentHandoffArtifact, writeOpenAgentHandoffArtifact, } from "./handoff.js";
import { buildOpenAgentLoopPrompt, clearOpenAgentLoopState, writeOpenAgentLoopState, } from "./loop-state.js";
...
import { formatOpenAgentReviewWorkflowResult, startOpenAgentReviewWorkflow, } from "./review-workflow.js";
import { formatOpenAgentRoutingStatus, inferOpenAgentPhase, isOpenAgentPhase, listOpenAgentPhases, routeOpenAgentPhase, } from "./routing.js";
import { formatOpenAgentCompactionStatus } from "./compaction.js";
import { formatOpenAgentTelemetry, recordLookAtInvocation, recordLoopCancel, recordLoopStart, } from "./telemetry.js";
import { formatOpenAgentWorkspaceRequirement, isOpenAgentWorkspaceAvailable, } from "./workspace.js";
    ...
    const allCommands = [
        ...
        },
        {
            ...
            handler: async (context) => {
                ...
                const fromAgent = isOpenAgentAgentName(currentAgentResult.agent?.name ?? "")
                    ? currentAgentResult.agent.name
                ...
                const artifact = await writeOpenAgentHandoffArtifact({
                    ...
                    fromAgent,
                    fromPhase,
                    fromMode: currentModeResult.mode === "interactive" ||
